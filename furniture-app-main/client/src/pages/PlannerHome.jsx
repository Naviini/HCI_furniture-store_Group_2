  ...
  const getTemplateSceneData = (roomTypeId, templateTitle) => {
    ...
    if (roomTypeId === 'living-room' && isClassic) {
      return {
        ...
        items: [
          ...
          { id: Date.now() + 15, type: 'TV Stand', position: [2.6, 0, 4.7], rotation: [0, Math.PI, 0], scale: [1, 1, 1], color: '#6b7280' },
        ],
    ...
    if (roomTypeId === 'kitchen' && isClassic) {
      return {
        ...
        items: [
          { id: Date.now() + 21, type: 'Kitchen', position: [-3.5, 0, 1.5], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1], color: '#f1f5f9' },
          ...
          { id: Date.now() + 26, type: 'Dining Chair', position: [1.8, 0, 1.2], rotation: [0, -Math.PI / 2, 0], scale: [1, 1, 1], color: '#ffffff' },
        ],
    ...
    if (roomTypeId === 'bathroom' && isClassic) {
      return {
        ...
        items: [
          { id: Date.now() + 31, type: 'Bathtub 2', position: [-1, 0, -2], rotation: [0, 0, 0], scale: [1, 1, 1], color: '#e2e8f0' },
          { id: Date.now() + 33, type: 'Toilet', position: [4.5, 0, -3.2], rotation: [0, -Math.PI/2, 0], scale: [1, 1, 1], color: '#ffffff' },
          { id: Date.now() + 34, type: 'Bathroom Closet', position: [-3.8, 0, 2], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1], color: '#e5e7eb' },
