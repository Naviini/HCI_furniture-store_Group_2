      ...
      <div className="relative z-10 flex flex-col w-full min-h-screen">
        ...
        {/* <header className="flex items-center justify-between p-6 lg:px-12 pt-10 lg:pt-12"> */}
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handleSkip}
              className={`group flex items-center gap-2 px-4 py-2 transition-colors text-sm font-medium bg-transparent cursor-pointer ${textSecondary} hover:${isDark ? 'text-white' : 'text-slate-900'}`}
            >
              Skip Intro
            ...
            <div className="mt-12 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                {ONBOARDING_STEPS.map((_, index) => (
                  <button
                    ...
                    className="group py-2 focus:outline-none bg-transparent cursor-pointer"
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className={`w-12 h-12 rounded-full p-0 flex items-center justify-center transition-all cursor-pointer ${backBtnClass} ${
                ...
                <button
                  onClick={handleNext}
                  className={`h-12 px-8 rounded-full hover:scale-105 transition-all font-semibold flex items-center gap-2 cursor-pointer ${nextBtnClass}`}
                >
