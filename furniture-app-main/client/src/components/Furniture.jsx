...
const MODEL_MAP = {
  ...
  'Desk Lamp':        { path: deskLampPath,      scale: 0.3,   yOffset: 0 },
  ...
  'File Cabinet':     { path: fileCabinetPath,   scale: 0.02,  yOffset: -25 },
  ...
  'Computer Table':   { path: computerTablePath, scale: 1.5,     yOffset: -0.5 },
  ...
  'Kitchen':           { path: kitchenPath,            scale: 1,   yOffset: 0 },
  'Kitchen Cabinet 1': { path: kitchenCabinet1Path,    scale: 15,     yOffset: 0 },
